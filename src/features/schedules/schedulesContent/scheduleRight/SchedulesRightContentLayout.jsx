...
export default function SchedulesRightContentLayout() {
  ...
  return (
    <div
      className={`medium:grid-cols-2 mb-18 grid grid-cols-1 space-y-6 gap-x-6 gap-y-2 lg:grid-cols-1 ${todaySessions.length === 0 ? `lg:h-50` : `${nearestSessions.length !== 0 ? `lg:h-100` : `lg:h-50`}`}`}
    >
